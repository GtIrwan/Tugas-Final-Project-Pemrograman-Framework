                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="/img/<?= $mahasiswa->foto; ?>"
            ...
            <div class="col-md-9">
                ...
                <div class="card card-primary">
                    ...
                    <form class="form-horizontal" method="post"
                        action="<?= base_url('mahasiswa/update/' . $mahasiswa->nim) ?>" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="card-body">
                            ...
                            <div class="form-group row"><label for="jurusan"
                                    class="col-sm-2 col-form-label">Jurusan</label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="jenis_kelamin" class="form-control" id="jenis_kelamin">
                                        <option value="pria"
                                            <?= ($mahasiswa->jenis_kelamin == "pria" ? "selected" : ""); ?>>Pria
                                        </option>
                                        <option value="wanita"
                                            <?= ($mahasiswa->jenis_kelamin == "wanita" ? "selected" : ""); ?>>
                                            Wanita</option>
                                    </select>
                                </div>
                            </div>
